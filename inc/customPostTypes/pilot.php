...
function registerPilotPostType()
{
    $labels = [
        'name'                  => _x('Pilots', 'Post Type General Name', 'flynt'),
        'singular_name'         => _x('Pilot', 'Post Type Singular Name', 'flynt'),
        'menu_name'             => __('Pilots', 'flynt'),
        'name_admin_bar'        => __('Pilot', 'flynt'),
    ...
    $args = [
        'label'                 => __('Pilot', 'flynt'),
        'description'           => __('Pilot Description', 'flynt'),
        'labels'                => $labels,
...
add_action('init', '\\Flynt\\CustomPostTypes\\registerPilotPostType');
