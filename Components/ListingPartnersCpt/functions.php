...
namespace Flynt\Components\ListingPartnersCpt;
...
add_filter('Flynt/addComponentData?name=ListingPartnersCpt', function ($data) {
    $postType = POST_TYPE;
...
Options::addTranslatable('ListingPartnersCpt', [
    [
