...
namespace Flynt\Components\BlockPartnerHeader;

use Flynt\Utils\Options;

add_filter('Flynt/addComponentData?name=BlockPartnerHeader', function ($data) {
    $data['dateFormat'] = get_option('date_format');
    return $data;
});

Options::addTranslatable('BlockPartnerHeader', [
    [
